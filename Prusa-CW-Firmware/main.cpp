...
static const __FlashStringHelper *str_back = reinterpret_cast<const __FlashStringHelper*>(pgmstr_back);
static const __FlashStringHelper *str_fan1_curing = reinterpret_cast<const __FlashStringHelper*>(pgmstr_fan1_curing);
static const __FlashStringHelper *str_fan1_drying = reinterpret_cast<const __FlashStringHelper*>(pgmstr_fan1_drying);
static const __FlashStringHelper *str_fan2_curing = reinterpret_cast<const __FlashStringHelper*>(pgmstr_fan2_curing);
static const __FlashStringHelper *str_fan2_drying = reinterpret_cast<const __FlashStringHelper*>(pgmstr_fan2_drying);
static const __FlashStringHelper *str_curing = reinterpret_cast<const __FlashStringHelper*>(pgmstr_curing);
static const __FlashStringHelper *str_drying = reinterpret_cast<const __FlashStringHelper*>(pgmstr_drying);
static const __FlashStringHelper *str_washing = reinterpret_cast<const __FlashStringHelper*>(pgmstr_washing);
static const __FlashStringHelper *str_resin_preheat = reinterpret_cast<const __FlashStringHelper*>(pgmstr_resin_preheat);
static const __FlashStringHelper *str_rotation_speed = reinterpret_cast<const __FlashStringHelper*>(pgmstr_rotation_speed);
static const __FlashStringHelper *str_run_mode = reinterpret_cast<const __FlashStringHelper*>(pgmstr_run_mode);
static const __FlashStringHelper *str_preheat = reinterpret_cast<const __FlashStringHelper*>(pgmstr_preheat);
static const __FlashStringHelper *str_sound = reinterpret_cast<const __FlashStringHelper*>(pgmstr_sound);
static const __FlashStringHelper *str_fans = reinterpret_cast<const __FlashStringHelper*>(pgmstr_fans);
static const __FlashStringHelper *str_led_intensity = reinterpret_cast<const __FlashStringHelper*>(pgmstr_led_intensity);
static const __FlashStringHelper *str_information_error = reinterpret_cast<const __FlashStringHelper*>(pgmstr_information_error);
static const __FlashStringHelper *str_information = reinterpret_cast<const __FlashStringHelper*>(pgmstr_information);
static const __FlashStringHelper *str_unit_system = reinterpret_cast<const __FlashStringHelper*>(pgmstr_unit_system);
static const __FlashStringHelper *str_fw_version = reinterpret_cast<const __FlashStringHelper*>(pgmstr_fw_version);
static const __FlashStringHelper *str_fan1_failure = reinterpret_cast<const __FlashStringHelper*>(pgmstr_fan1_failure);
static const __FlashStringHelper *str_fan2_failure = reinterpret_cast<const __FlashStringHelper*>(pgmstr_fan2_failure);
static const __FlashStringHelper *str_heater_failure = reinterpret_cast<const __FlashStringHelper*>(pgmstr_heater_failure);
static const __FlashStringHelper *str_serial_number = reinterpret_cast<const __FlashStringHelper*>(pgmstr_serial_number);
static const __FlashStringHelper *str_build_nr = reinterpret_cast<const __FlashStringHelper*>(pgmstr_build_nr);
static const __FlashStringHelper *str_fw_hash = reinterpret_cast<const __FlashStringHelper*>(pgmstr_fw_hash);
static const __FlashStringHelper *str_workspace = reinterpret_cast<const __FlashStringHelper*>(pgmstr_workspace);
